# coding: utf-8
"""ESMDIAG's climo/zonal_mean figure workflow.
...
Run the following command to test:
   ...
   $ airflow trigger_dag \
     ...
     ploto_esmdiag_climo_zonal_mean
...
dag_id = "ploto_esmdiag_climo_zonal_mean"
...
with DAG(
    ...
    for field in fields:
        ...
        select_steps[field] = select_data_step
    ...
    for field in ["U", "V", "T"]:
        ...
        vinterp_step.set_upstream([select_steps[field], select_steps["PS"]])
        vinterp_steps.append(vinterp_step)
    ...
    vinterp_steps.append(gw_select_step)
    plot_step.set_upstream(vinterp_steps)
