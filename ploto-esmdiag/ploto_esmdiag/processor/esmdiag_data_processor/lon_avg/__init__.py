...
def run_processor(task, work_dir, config) -> bool:
    ...
    :param task:
        {
            ...
            'var_name': 'PRC',
            'output_file': 'GAMIL.gamil_wu_run11.PRC.daily.anomaly.lon_avg_lat_band.1992-01-01:1993-12-31.n'
            'common_config': {
                'model_info': {
                    'id': "FGOALS-g3",
                    'atm_id': "GAMIL",
    ...
    ncl_script = Path(config["esmdiag"]["root"], 'ncl_scripts', 'lon_avg.ncl')
    ...
    ncl_command = (
        ...
        'out_path=\\"{out_path}\\"'.format(
            ...
            start_lon=task['start_lon'],
            end_lon=task['end_lon'],
